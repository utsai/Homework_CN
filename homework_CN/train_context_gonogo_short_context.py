"""Training script for the short-context 3-context Go/No-Go coursework task.

Created by Cai Chunqiu on May 7, 17:11.
"""
...
class ContextGoNoGoTask:
    ...
    The context cue appears only at t=0. The stimulus appears only at t=1.
...
class Trainer:
    ...
    def plot_training_curves(self, save_path=None):
        ...
        axes[3].text(
            ...
            "Context at t=0; stimulus at t=1; go cue at final step.",
            ha="left",
            va="top",
            fontsize=10,
        )
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train RNNs on a short-context 3-context Go/No-Go task.")
    ...
    parser.add_argument(
        "--output-dir",
        default=os.path.join(os.path.dirname(__file__), "outputs_short_context"),
    )
